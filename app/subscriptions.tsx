...
export default function SubscriptionsScreen() {
  ...
  const getSavings = (plan: SubscriptionPlan) => {
    ...
    return Math.round(
      ((yearlyMonthly - plan.yearlyPrice) / yearlyMonthly) * 100,
    );
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            <View
              style={[styles.saveBadge, { backgroundColor: colors.success }]}
            >
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.guaranteeContainer}>
            ...
            />
            <Text
              style={[styles.guaranteeText, { color: colors.textSecondary }]}
            >
...
function SubscriptionCard({
  ...
  return (
    <View
      style={[styles.cardWrapper, plan.popular && styles.popularCardWrapper]}
    >
      {plan.popular && (
        <LinearGradient
      ...
      >
        ...
        {plan.hidden && (
          <View
            style={[styles.hiddenBanner, { backgroundColor: colors.error }]}
          >
            <Ionicons name="eye-off" size={16} color="#FFFFFF" />
            <Text style={styles.hiddenBannerText}>
              This plan is not visible now
            </Text>
          </View>
        )}
