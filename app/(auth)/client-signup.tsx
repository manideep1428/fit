  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      const signUpResult = await signUp.create({
        ...
        lastName:
          invitationData.fullName.split(" ").slice(1).join(" ") || undefined,
        unsafeMetadata: {
          role: "client",
        },
      });
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text className="text-sm" style={{ color: colors.textSecondary }}>
              You can only sign up if your trainer has invited you. Make sure to
              use the exact email address they provided.
            </Text>
          </View>
