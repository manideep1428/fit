...
export default function ClientQuestionsScreen() {
  ...
  const addCustomQuestion = () => {
    ...
    const updated = [...questions, { question: newQuestion.trim(), answer: "" }];
    setQuestions(updated);
    saveQuestions(updated);
    setNewQuestion("");
  };
        ...
        <ScrollView className="flex-1 px-4 py-4" showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            <Text className="text-sm" style={{ color: colors.textSecondary }}>
              Add questions to gather information from your client during onboarding. These will be saved with the client profile.
            </Text>
          </View>
              ...
              <View className="flex-row items-center">
                ...
                <View>
                  ...
                  <Text className="text-xs" style={{ color: colors.textSecondary }}>
                    {availableFaqs?.length || 0} questions available
                  </Text>
                </View>
              </View>
              <Ionicons
                name={showFaqPicker ? "chevron-up" : "chevron-down"}
                size={20}
